#' sambadaOnR: A package for running sambada within R with pipeline from pre to post-processing
#'
#' The sambadaOnR package provides four categories of important functions:
